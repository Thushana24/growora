...
import useGetBrowerDocument from "@/hooks/useGetBrowserDocument";
        ...
        >
          ...
          >
            <SelectPrimitive.Content
              ...
              className={cn(
                // Base styles
                "z-50 min-w-(--radix-select-trigger-width) overflow-hidden rounded-xl shadow-lg",
                "dark:from-primary-dark dark:to-primary-dark-foreground bg-linear-to-br from-gray-900 to-gray-950 ring-1 ring-gray-800 dark:bg-linear-to-br dark:ring-white/10",
